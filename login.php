...
<body>
  ...
  <div class="d-flex justify-content-center align-items-center vh-100">
    ...
    <i class="fas fa-plus-circle" style="color: #007bff; margin-right: 2px;"></i>
    Health-e
</h3>
        ...
        <form id="loginForm">
          ...
          <div class="text-center mt-4">
            <button type="submit" class="btn btn-primary btn-lg w-100" style = "font-weight: bold;">Sign In</button>
  ...
  <footer class="bg-primary text-white text-center py-4">
    <p class="mb-0">© 2024 Hayakawa Electronics (Phil.s). Corp. All rights reserved.</p>
  </footer>
