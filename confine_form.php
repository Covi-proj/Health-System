    ...
    <div class="form-container">
        ...
        <form action="add_fit.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <label for="RR">Total of Hours :</label>
                    <input type="number" id="date_ofabs" name="total_hrs" placeholder="Total of hrs." required>
                </div>


                <div class="form-group">
                    <label for="remarks">Remarks :</label>
                    <input id="text" id="nod" name="remarks" placeholder="Remarks" required>
                </div>

                <div class="form-group">
                    <label for="remarks">Note :</label>
                    <input id="text" id="note" name="nod" placeholder="Note" required>
                </div>
