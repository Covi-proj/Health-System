...
$emp = $pnt_name = $division = $company = $c_date = $rcv = $bp = $temp = $HR = $RR = $O2_sat = $medicine = $qty = $diagnosis = $remarks = '';
        ...
        <input type="hidden" name="c_id" value="<?= htmlspecialchars($c_id) ?>">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="emp" name="emp" placeholder="Emp. No."  value="<?= htmlspecialchars($emp) ?>" required>
                </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select id="company" name="company" placeholder = "status" style ="height: 40px; border-radius: 10px;">
                        <option><?= htmlspecialchars($company) ?></option>
                        ...
                        <option value="Nat. Corp.">Nat. Corp.</option>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="rcv" name="rcv" value="<?= htmlspecialchars($rcv) ?>" placeholder="Reason of Visit">
                </div>
            ...
            <div class="form-group">
                ...
                <textarea id="diagnosis" name="diagnosis" placeholder="Diagnosis"><?= htmlspecialchars($diagnosis) ?></textarea>
