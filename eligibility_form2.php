...
<body>
    ...
    <div class="form-container">
        <h2>Eligibility Form / Fit to Work</h2>
        <form action="add_fit2.php" method="POST">
            <!-- Row 1 -->
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <label for="division">Time In</label>
                    <input type="time" id="time-in" name="time_in" required>
                </div>
                <div class="form-group">
                    <label for="company">Time Out</label>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="date_ofabs" name="date_ofabs" placeholder="Date of Absence" required>
                </div>
                <div class="form-group">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="nod" name="nod" placeholder="Notice of Determination" required>
                </div>
                <div class="form-group">
                <label for="remarks">Remarks</label>
                <input id="text" name="remarks" rows="4" placeholder="Remarks or concerns" required>
                </div>
            </div>
            ...
            <div class="btn-group">
                ...
                <button type="button" class="btn-cancel" onclick="window.location.href='super-admin.php#fit';">Cancel</button>
            </div>
        </form>
    </div>
</body>
